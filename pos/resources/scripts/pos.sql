...
COMMENT ON COLUMN PAYMENT.TOTAL_PRICE IS '총금액';
...
COMMENT ON COLUMN BILL.BILL_DATE IS '결제시간';
...
-- BILL
INSERT INTO BILL VALUES(1,1,'칼국수',7000, 7000, 1, SYSDATE, 1);
INSERT INTO BILL VALUES(2,2,'된장찌개',7000, 14000, 1, SYSDATE, 2);
INSERT INTO BILL VALUES(3,2,'김치찌개',7000, 14000, 1, SYSDATE, 2);
INSERT INTO BILL VALUES(4,3,'제육볶음(중)',20000, 22000, 1, SYSDATE, 3);
INSERT INTO BILL VALUES(5,3,'음료수',2000, 22000, 1, SYSDATE, 3);

-- PAYMENT
INSERT INTO PAYMENT VALUES(1, 1, SYSDATE, '현금', 'Y', 7000, 7000);
INSERT INTO PAYMENT VALUES(2, 2, SYSDATE, '카드', 'Y', 14000, 14000);
INSERT INTO PAYMENT VALUES(3, 3, SYSDATE, '현금', 'Y', 22000, 22000);
...
-- BILL ROW시퀀스
DROP SEQUENCE SEQ_BILLROW;
CREATE SEQUENCE SEQ_BILLROW
START WITH 6;
...
--PAYMENT ROW 시퀀스
DROP SEQUENCE SEQ_PAYROW;
CREATE SEQUENCE SEQ_PAYROW
START WITH 4;

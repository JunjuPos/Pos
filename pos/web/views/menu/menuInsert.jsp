...
<body>
	...
	<form action="<%=request.getContextPath() %>/menuInsert.mn" method="post">
	<div id="menuArea">
		<h1 align="center">신 메뉴등록</h1>
		<br>
		<table>
			<tr>
				<th>메뉴명</th><td><input type="text" id="mnName" name="mnName" required></td>
			</tr>
			<tr>
				<th>카테고리</th>
				<td>
					<select name="cate" id="cate">
						...
						<option value="주류/음료">음료</option>
						<option value="기타">기타</option>
					</select>
				</td>
			</tr>
			<tr>
				<th>가격</th><td><input type="number" id="inPrice" name="inPrice" value=0 required></td>
			</tr>
			<tr>
				<th>등록여부</th>
				<td>
		...
		<br><br>
		<div id="btnArea">
			<button type="submit" id="menuInsert">등록</button>
